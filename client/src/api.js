...
export const api = {
  ...
  updateBubbleRadius: (radius) => request('/users/me/bubble-radius', { method: 'PATCH', body: JSON.stringify({ radius }) }),
  updateChatSize: (size) => request('/users/me/chat-size', { method: 'PATCH', body: JSON.stringify({ size }) }),
